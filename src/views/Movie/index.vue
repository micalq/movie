...
<style scoped>
#content .movie_menu{ width: 100%; height: 45px;margin-top: 50px;position: fixed; border-bottom:1px solid #e6e6e6; display: flex; justify-content:space-between; align-items:center; background:white; z-index:10;}
